...
public class Ally : Character {
    ...
    public static string baseName = "AlliesBase";
    ...
    {
        List<GameObject> enemies = new List<GameObject>(GameObject.FindGameObjectsWithTag(Enemy.tagName));
        ...
        gameCharaters.Add(GameObject.FindGameObjectWithTag(Enemy.baseName));
